...
public class Model {
    ...
    private MoveEfficiency getMoveEfficiency(Move move){
        MoveEfficiency moveEfficiency1 = new MoveEfficiency(getEmptyTilesCount(),score,move);
        move.move();
        if(!hasBoardChanged()){
            MoveEfficiency moveEfficiency2 = new MoveEfficiency(-1,0,move);
            return moveEfficiency2;
        }
        rollback();
        return moveEfficiency1;
    }
    public void autoMove(){
        PriorityQueue<MoveEfficiency> queue = new PriorityQueue<>(4,Collections.reverseOrder());
        queue.add(new MoveEfficiency(getEmptyTilesCount(),score,this::left));
        queue.add(new MoveEfficiency(getEmptyTilesCount(),score,this::up));
        queue.add(new MoveEfficiency(getEmptyTilesCount(),score,this::right));
        queue.add(new MoveEfficiency(getEmptyTilesCount(),score,this::down));
